...
public sealed class ClientCharacterWrapper : ICharacterWrapper
{
    public ClientCharacterWrapper(NetPlayer player, CharacterModel model)
    {
        _owner = player;
        _model = model;
    }
    ...
    public bool SupportsChange => false;
