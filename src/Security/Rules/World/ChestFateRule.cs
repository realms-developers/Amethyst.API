...
public sealed class ChestFateRule : ISecurityRule
{
    public string Name => "coresec_wldChestFate";

    public void Load(NetworkInstance net)
    {
        net.SecureIncoming[32].Add(OnChestFate);
    }

    private bool OnChestFate(in IncomingPacket packet)
    {
    ...
    {
        net.SecureIncoming[33].Remove(OnChestFate);
    }
}
