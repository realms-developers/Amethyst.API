...
{
    internal static NetworkInstance Instance = new NetworkInstance();
    ...
    internal static void RequestListening()
    {
        Provider.StartListening();
    }

    public static void SetupProvider(INetworkProvider provider)
    {
        Provider = provider;
    }
}